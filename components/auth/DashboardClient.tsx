          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3 space-x-reverse">
              ...
              <Button
                ...
                className="flex items-center space-x-2 space-x-reverse bg-white/50 hover:bg-white/80 border-white/20 text-slate-700 hover:text-slate-900 transition-all duration-200 focus-visible rounded-xl"
              >
            ...
            <div className="flex items-center space-x-6 space-x-reverse">
              ...
              <div className="flex-1 space-y-4">
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mt-1">به داشبورد خود خوش آمدید</p>
                </div>
                
                <div className="flex flex-wrap gap-6 text-sm">
                  <div className="flex items-center space-x-2 space-x-reverse text-slate-600 dark:text-slate-400">
                    <Mail className="w-4 h-4 text-slate-400 dark:text-slate-500" />
                    <span className="break-all">{user.email}</span>
                  </div>
                  <div className="flex items-center space-x-2 space-x-reverse text-slate-600 dark:text-slate-400">
                    <Phone className="w-4 h-4 text-slate-400 dark:text-slate-500" />
                    <span className="font-mono text-left tabular-nums tracking-wider" dir="ltr">
            ...
            <div className="glass-card rounded-3xl p-6 card-hover">
              ...
              <div className="space-y-4">
                ...
                <div className="py-3">
                  ...
                  <span className="text-sm font-medium text-slate-900 dark:text-slate-100 break-words text-left block">{user.email}</span>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-3xl p-6 card-hover">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3">
                  ...
                  <span className="text-sm font-medium text-slate-900 dark:text-slate-100 font-mono text-left tabular-nums tracking-wider" dir="ltr">
                    {user.phoneNormalized}
                  </span>
                </div>
              </div>
